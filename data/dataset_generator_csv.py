"""
Enhanced SMPP Dataset Generator
Генератор датасету з типологізованими аномаліями
"""
...
class EnhancedSMPPDatasetGenerator:
    ...
    def __init__(self, seed=42, config_path="config/data_config.json"):
        ...
        logging.info("Enhanced SMPP Dataset Generator initialized")
    ...
    def generate_weekly_traffic(self, messages_per_day: int = 5000, anomaly_rate: float = 0.15) -> pd.DataFrame:
...
if __name__ == "__main__":
    ...
    generator = EnhancedSMPPDatasetGenerator()
